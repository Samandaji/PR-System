<?php 
  ...
  if (isset($_POST['register'])) 
  {
    ...
    $admin = new Admin();
    $adminAdded = $admin->register($admin_id, $fname, $lname, $oname, $email, $phone, $password);
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="POST">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="" placeholder="Admin_ID...." name="admin_id">
                </div>
                 <div class="form-group">
